...
Revision ID: 936401bc2e86
Revises: 
Create Date: 2025-05-07 16:25:02.211904
...
def downgrade():
    ...
    with op.batch_alter_table('students', schema=None) as batch_op:
        batch_op.add_column(sa.Column('semester', sa.INTEGER(), autoincrement=False, nullable=True))
        batch_op.add_column(sa.Column('skills', sa.VARCHAR(length=255), autoincrement=False, nullable=True))
